...
<head>
    ...
    function confirmCancellation(orderId) {
        if (confirm("Are you sure you want to cancel this order?")) {
            window.location.href = "cancel-order.php?oid=" + orderId;
        }
    }
    </script>
<!-- Google Translate -->
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td class="cart-total last-item">
                                            ...
                                            <?php if($row['ostatus'] != 'Cancelled') { ?>
                                                <br><br>
                                                <a href="javascript:void(0);" onClick="confirmCancellation('<?php echo htmlentities($row['orderid']);?>');" title="Cancel order">Cancel</a>
                                            <?php } ?>
                                        </td>
                                        <td class="cart-total last-item">
    <a href="invoice.php?oid=<?php echo htmlentities($row['orderid']);?>" target="_blank" title="Download Invoice">Invoice</a>
</td>
